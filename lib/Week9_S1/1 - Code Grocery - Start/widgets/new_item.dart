...
class _NewItemState extends State<NewItem> {
  static const GroceryCategory DEFAULT_CATEGORY =  GroceryCategory.hygiene;

  String? _itemName;
  String? _itemQuantity;
  GroceryCategory _selectedCategory = DEFAULT_CATEGORY;
  ...
  void _onReset() {
    ...
    setState(() {
      _itemName = null;
      _itemQuantity = '1'; 
      _selectedCategory = DEFAULT_CATEGORY; 
    });
  }
 // for check the validate title 
  String? validateTitle(String? value) {
    if (value == null ||
        value.isEmpty ||
        value.trim().length <= 1 || // trim: is mean remove space 
        value.trim().length > 50) {
      return 'Must be between 1 and 50 characters.';
    }
    return null;
  }
//for check the validate quantity
